...
?>
    ...
    <section id="Categorie" class="containerCategorie">
        ...
        <div class="categories_2">
            <div id="exCategorie">
                <a href="#"><img id="img_cat" src="picture/men.svg" alt=""><p class="text">Men</p></a>
            </div>
            <div id="exCategorie">
                <a href="#"><img id="img_cat" src="picture/children.jpeg" alt=""><p class="text">Children</p></a>
            </div>
            <div id="exCategorie">
                <a href="#"><img id="img_cat" src="picture/women.jpeg" alt=""><p class="text">Women</p></a>
            </div>
        </div>
    </section>
    <!-- section posts here => -->
    ...
    <section>
        <div id="container">
            <div class="text-container"><h1>Top Brands Deal</h1></div>
            <div class="text-container"><p>Up To <span> 60% </span> off on brands</p></div>
    ...
    <section >
        <div class="contianer_feedback">
            <div class="title_section"><h3>Feedback</h3></div>
              <div class="allBox">
                <div class="box-1">
                  <div id="twoimages">
